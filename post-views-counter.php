<?php
/*
Plugin Name: Awesome Post Views Counter
...
Plugin URI: http://smartcoderbd.com/awesome-post-views-counter/
...
if ( ! class_exists( 'Post_Views_Counter' ) ) :
	...
	final class Post_Views_Counter {
		...
		public function plugin_row_meta( $links, $file ) {
			...
			if ( $file == $plugin ) {
				return array_merge(
					$links, array( sprintf( '<a href="smartcoderbd.com" target="_blank">%s</a>', __( 'Support', 'post-views-counter' ) ) )
				);
			}
